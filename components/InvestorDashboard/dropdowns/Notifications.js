...
const Notifications = ({ onClose, notifications }) => {
  ...
  return (
    <div className="absolute top-20 z-50 space-y-1 shadow-lg bg-greyBg right-3 md:right-14 rounded-md w-[95%] md:w-[400px]">
      {/* Header */}
      <div className="flex justify-between items-center px-5 py-3 bg-white rounded-tl-md rounded-tr-md">
      ...
      {notifications?.length === 0 ? (
        <div className="h-[300px] flex flex-col justify-center bg-white shadow-lg">
        ...
        <div className="h-[420px] md:h-[500px] overflow-scroll scrollable-box space-y-1 bg-transparent shadow-lg">
          {notifications.map((notification, index) => (
            <div key={index} className="px-5 py-2 space-y-2 bg-white">
              {/* Notification header */}
      ...
      {/* Footer */}
      <div className="flex flex-col items-center px-5 py-3 bg-white rounded-bl-md rounded-br-md">
