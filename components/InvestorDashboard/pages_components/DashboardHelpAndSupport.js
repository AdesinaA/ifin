...
const DashboardHelpAndSupport = () => {
  ...
  return (
    <div className={`space-y-10 lg:pb-5 pt-3 scrollable-box  bg-greyBg`}>
      {/* Header */}
      <div className="bg-white rounded-xl md:py-10 p-5 md:px-8 xl:px-10 2xl:px-16 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-5">
          {supportCards.map((card, index) => (
            <div
              key={index}
              className="bg-white rounded-md p-5 space-y-10 col-span-1"
            >
              {card.icon}
              <div className="space-y-1">
