...
const WithdrawalPageModal = ({
  ...
  return (
    <div className="absolute inset-0 bg-gray-200/60 flex items-center overflow-hidden justify-center z-50">
      {isLoading ? (
        <div
          className="bg-white px-5 py-10 md:px-10 md:pt-20 md:pb-10 rounded-xl w-[95%] md:w-[450px] overflow-scroll
  scrollable-box relative"
        >
          ...
          <div className="space-y-5">
            ...
            <button
             ...
             border-borderColor text-black w-1/2 py-3 rounded-lg capitalize cursor-pointer text-center block mx-auto"
              onClick={onClose}
            >
              Close
            </button>
        ...
        <>
          {isSucces ? (
            <div
              className="bg-white px-5 py-10 md:pt-10 md:pb-5 md:px-10 rounded-xl w-[95%] md:w-[520px] h-[500px] md:h-auto overflow-scroll
           scrollable-box space-y-7 relative"
            ...
            <div
              className="bg-white px-5 py-10 md:p-10 rounded-xl w-[95%] md:w-[450px] overflow-scroll
       scrollable-box space-y-7 relative"
            >
              <div className="space-y-7">
                <Image
              ...
              <div
                className="w-10 h-10 rounded-full flex justify-center items-center bg-white border
           border-gray-200/50 cursor-pointer absolute top-0 right-5"
                onClick={onClose}
              >
                <X size={20} />
              </div>
