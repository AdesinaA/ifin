...
const InvestmentConfirmationModal = ({
  ...
  return (
    <div className="absolute inset-0 bg-gray-200/60 flex items-center overflow-hidden justify-center z-50">
      <div
        className="bg-white px-5 py-10 md:p-10 rounded-xl w-[95%] md:w-[520px] h-[500px] md:h-auto overflow-scroll
      ...
      >
        ...
        <div className="space-y-7">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-sm">
              Your investment in the Bronze Growth 100 has been successfully
        ...
        <div className="bg-backgroundSecondary rounded-xl p-5 space-y-5">
          <h3 className="text-[#494552] text-sm">Payment Summary</h3>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <p className="font-medium">{pkg?.amount}</p>
            </div>
