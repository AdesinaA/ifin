...
const PersonalSettingsModal = ({ onClose, initialData, token }) => {
  ...
  return (
    <div className="absolute inset-0 bg-gray-200/60 flex items-center overflow-hidden justify-center z-50">
      <div className="bg-white py-10 px-5 md:p-10 rounded-xl w-[95%] md:w-[580px] h-[500px] md:h-auto overflow-scroll scrollable-box space-y-10">
        ...
        <div className="space-y-2">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start gap-3 text-white text-center">
              <button
                type="button"
                className="bg-backgroundSecondary border border-borderColor text-black w-1/2 py-2 rounded-lg capitalize cursor-pointer"
                onClick={onClose}
              >
                Cancel
              </button>
