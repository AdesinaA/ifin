...
const LegalModal = ({ onClose }) => {
  return (
    <div className="absolute inset-0 bg-gray-200/60 flex items-center overflow-hidden justify-center z-50">
      <div className="bg-white md:p-10 px-5 py-10 rounded-xl w-[95%] md:w-[580px] overflow-scroll scrollable-box space-y-10">
        ...
        <button
          type="button"
          className="bg-backgroundSecondary border border-borderColor text-black w-full py-2 rounded-lg capitalize cursor-pointer"
          onClick={onClose}
        >
          Cancel
        </button>
