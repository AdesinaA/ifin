  ...
  ({
    ...
    return (
      <div className={`${indentClass} transition-all duration-200`}>
        <div
          className={`flex items-center p-3 my-1 rounded-md hover:bg-gray-50 ${
            isRoot ? "bg-blue-50" : ""
          }`}
        >
          ...
          <div className="border-l-2 border-gray-200 ml-4 pl-2">
            ...
            {showMoreCount > 0 && (
              <button
                ...
                className="flex items-center gap-2 ml-4 mt-2 mb-2 text-sm text-blue-600 hover:text-blue-800"
              >
                <Plus size={16} />
                <span>
