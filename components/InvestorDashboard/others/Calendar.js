...
export default function Calendar({ onSelectDate, selectedDate }) {
  ...
  return (
    <div className="bg-white rounded-[32px] shadow-lg p-6 w-[400px] font-[-apple-system]">
          ...
          return (
            <div
              ...
              className={`
                ...
                ${day.isCurrentMonth ? "text-black" : "text-[#E5E5E5]"}
              `}
            >
              <button
                ...
                className={`
                  ...
                  ${isSelected ? "bg-[#1D4ED8] text-white" : "hover:bg-gray-50"}
                  transition-colors
                `}
              >
                {day.date.getDate()}
